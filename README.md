...
| `urirun-connector-subactor-managed-tunnel` | `tunnel://host/outbound/query/preflight` | [native/subactor-managed-tunnel/v0.1.0](native/subactor-managed-tunnel/v0.1.0) |
| `urirun-connector-subactor-secret-intake` | 2 existing `browser://host/secret-intake/command/` routes | [native/subactor-secret-intake/v0.2.0](native/subactor-secret-intake/v0.2.0) |
| `urirun-connector-subactor-credential-harvest` | `hub://host/credential/command/harvest` | [native/subactor-credential-harvest/v0.1.1](native/subactor-credential-harvest/v0.1.1) |
